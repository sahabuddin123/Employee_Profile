                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label" for="data_11"> Link start time <span class="m-l-5 text-danger"> *</span></label>
                                                    ...
                                                    <input class="form-control @error('starttime') is-invalid @enderror" type="date" name="starttime" id="data_11" placeholder="Please Type " required value="{{ old('starttime')}}" autocomplete="off"/>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label" for="data_21"> Link end time <span class="m-l-5 text-danger"> *</span></label>
                                                    ...
                                                    <input class="form-control @error('endtime') is-invalid @enderror" type="date" name="endtime" id="data_21" placeholder="Please Type " required value="{{ old('endtime')}}" autocomplete="off"/>
