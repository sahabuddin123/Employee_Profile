...
<div class="app-title" id="ides1">
  <a href="{{ route('admin.link.docxPDF', $link) }}" class="btn btn-primary pull-right">Save PDF</a>
</div>
...
foreach($id as $key => $val){
    $id = $val;
    $personal = App\Models\Personalinfo::find($id);
    $education = App\Models\Education::where('empID',$val)->get();
    $language = App\Models\Language::where('empID',$val)->get();
    $employeeinfo = App\Models\Employeeinfo::where('empID',$val)->get();
    $reference = App\Models\Reference::where('empID',$val)->get();
    $skill = App\Models\Skill::where('empID',$val)->get();
    $traning = App\Models\Traning::where('empID',$val)->get();
    $workexpreance = App\Models\Workexpreance::where('empID',$val)->get();
    $document = App\Models\Document::where('empID',$val)->get();
?>
          ...
          <div class="A4Size">
            ...
            <section>
              <article>
                ...
                <table border="1" width="20%" style="float:right;">
                    <tr >
                        <th align="center">
                            <a data-magnify="gallery" data-src="" data-caption="{{ $personal->name}}" data-group="a"
