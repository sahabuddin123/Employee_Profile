    ...
    <div class="row">
        <div class="col-md-12">
            <div class="user-data m-b-30" style="padding:30px;">
                <h3 class="m-b-30">
                    <i class="fa fa-tags"></i> {{ "Create Link" }}
                </h3>
            <div class="tile">
                <div class="tile-body">
    ...
    <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <form action="{{ route('admin.link.store') }}" method="post">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label" for="data_1"> Link start time <span class="m-l-5 text-danger"> *</span></label>
                                                <div class='input-group date' id='datetimepicker2'>
                                                    <input class="form-control @error('starttime') is-invalid @enderror" type="text" name="starttime" id="data_1" placeholder="Please Type " required value="{{ old('starttime')}}" autocomplete="off"/>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label" for="data_2"> Link end time <span class="m-l-5 text-danger"> *</span></label>
                                                <div class='input-group date' id='datetimepicker1'>
                                                    <input class="form-control @error('endtime') is-invalid @enderror" type="text" name="endtime" id="data_2" placeholder="Please Type " required value="{{ old('endtime')}}" autocomplete="off"/>
                                                    <span class="input-group-addon">
                                                        <span class="glyphicon glyphicon-calendar"></span>
                                                    </span>
