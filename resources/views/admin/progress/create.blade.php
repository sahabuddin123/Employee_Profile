    ...
    $(function () {
        $('.add').click(function () {
            ...
            var tr = '<tr><td class="no">' + n + '</td>' +
                    ...
                    '<td><input type="date" class="wstart form-control" name="wstart[]" value="{{ old('wstart') }}" style="width:110px;"></td>'+
                    '<td><input type="date" class="wend form-control" name="wend[]" value="{{ old('wend') }}" style="width:110px;"></td>'+
                    ...
                    <div class="tile">
                        ...
                        <form action="{{ route('admin.progress.update') }}" method="POST" role="form" enctype="multipart/form-data">
                            ...
                            <div class="tile-body">
                                ...
                                <select name="Pid" class="form-control" id="title">
                                    @foreach (App\Models\Project::all() as $item2)
                                        <option value="{{$item2->id}}">{{$item2->jobno}}</option>
                                    @endforeach
                                </select>
                                <table class="table table-striped" width="100%">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th style="width:300px">Work Title</th>
                                    ...
                                    <tbody class="resultbody">
                                        ...
                                        <tr>
                                            <td class="no">{{ $x }}</td>
                                            <td>
                                                <input type="text" class="Dgname form-control" name="Dgname[]" value="{{ old('Dgname') }}" style="width:250px">
                                            </td>
                                            <td>
                                                <input type="text" class="twork form-control" name="twork[]" value="{{ old('twork') }}">
                                            </td>
                                            <td>
                                                <input type="text" class="cwork form-control" name="cwork[]" value="{{  old('cwork') }}">
                                            </td>
                                            <td>
                                                <input type="date" class="wstart form-control" name="wstart[]" value="{{ old('wstart') }}" style="width:110px;">
                                            </td>
                                            <td>
                                                <input type="date" class="wend form-control" name="wend[]" value="{{ old('wend') }}" style="width:110px;">
                                            </td>
                                            <td>
                            ...
                            <div class="tile-footer">
                              <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Save Progress Info</button>
                                &nbsp;&nbsp;&nbsp;
