...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="user-data m-b-30">
                ...
                <i class="zmdi zmdi-account-calendar"></i>{{ "Edit Project Link" }}</h3>
            <div class="tile">
                <div class="tile-body">
    ...
    <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright" style="padding:20px;">
                                    ...
                                    <form action="{{ route('admin.projectlink.update') }}" method="post">
                                        @csrf
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label" for="data1_1"> Link start time <span class="m-l-5 text-danger"> *</span></label>

                                                    <input class="form-control @error('starttime') is-invalid @enderror" type="date" name="starttime" id="data1_1" placeholder="Please Type " required value="{{ old('starttime', $data->starttime)}}" autocomplete="off"/>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label" for="datae_2"> Link end time <span class="m-l-5 text-danger"> *</span></label>

                                                    <input class="form-control @error('endtime') is-invalid @enderror" type="date" name="endtime" id="datae_2" placeholder="Please Type " required value="{{ old('endtime', $data->endtime)}}" autocomplete="off"/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class='input-group'>
                                                    <select class="form-control @error('role') is-invalid @enderror" name="role" id="data_10">
                                                        ...
                                                        <option value="0" @if($role == 0) selected @endif>Short Link</option>
                                                        <option value="1" @if($role == 1) selected @endif>Full Link</option>
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class='input-group'>
                                                    <select class="form-control @error('cvlink') is-invalid @enderror" name="cvlink" id="data_10">
                                                        <option value="0" @if($data->cvlink == 0) selected @endif>Short Link</option>
                                                        <option value="1" @if($data->cvlink == 1) selected @endif>Full Link</option>
                                                    </select>
